      ...
      <div className="max-w-[760px] mx-auto px-5 md:px-10 py-12 md:py-16 flex flex-col gap-12">
        ...
        <section className="flex flex-col gap-4">
          ...
          <p className="text-[15px] text-text-muted leading-relaxed m-0">
            LoteCUU es un catálogo digital de autos usados en la ciudad de Chihuahua. Reúne en un solo
            lugar el inventario de lotes y vendedores locales para que puedas explorar, comparar y encontrar
            el auto que buscas.
          </p>
          <p className="text-[15px] text-text-muted leading-relaxed m-0">
            Cada auto pertenece a un lote o vendedor verificado. En su ficha encuentras la información del
            vehículo y el contacto directo de quien lo vende — teléfono, WhatsApp o correo — para que trates
            directamente con él.
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                desc: 'En cada ficha está el contacto directo del vendedor. Llámale o escríbele por el medio que prefieras.',
              },
            ].map((step) => (
              <div
                key={step.num}
        ...
        >
          ...
          <p className="text-[15px] text-text-muted leading-relaxed m-0">
            ...
            profesional en Chihuahua. Contáctanos y nosotros damos de alta tu perfil y tu inventario — o
            te damos acceso para que lo administres tú mismo. Los compradores te contactan directamente a ti.
          </p>
          <div className="flex flex-wrap gap-3 mt-1">
            {['Inventario en línea', 'Fotos de tus autos', 'Contacto directo', 'Perfil de vendedor'].map((f) => (
              <span
                key={f}
            ...
            {[
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <a
                    href={`https://wa.me/${c.wa}?text=Hola%2C%20me%20gustar%C3%ADa%20saber%20m%C3%A1s%20sobre%20LoteCUU`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2.5 text-[13px] text-white/80 hover:text-white transition-colors"
                  >
                    <span className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0" style={{ background: '#25D366' }}>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 text-[13px] text-white/80 hover:text-white transition-colors"
                  >
                    <span className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0" style={{ background: 'rgba(255,255,255,0.12)' }}>
